...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`After Museum`}</title>

        <meta
          name="description"
          content="After Museum: Embrace the Asian heritage with our comprehensive museum gallery management solution, designed to bring art and culture to your fingertips."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1518998053901-5348d3961a04?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtdXNldW18ZW58MHx8fHwxNjk2NTEyMDIzfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@dannie_jing?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Dannie Jing`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`After Museum: Embrace the Asian heritage with our comprehensive museum gallery management solution, designed to bring art and culture to your fingertips.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                ...
                <Card userTypeName="Visitor" type="visitor" abilities={appConfig.customerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
